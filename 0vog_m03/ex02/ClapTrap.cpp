...
ClapTrap::ClapTrap(void): _name("NO_NAME_GIVEN"), _hp(100), _ep(50), _ad(20)
{
	std::cout << "ClapTrap constructor by default called [" << this->_name << "]" << std::endl;
	return ;
}

ClapTrap::ClapTrap(std::string name): _name(name), _hp(100), _ep(50), _ad(20)
{
	std::cout << "ClapTrap constructor from std::string called [" << this->_name << "]" << std::endl;
	return ;
}
...
{
	*this = src;
	std::cout << "ClapTrap constructor by copy called [" << this->_name << "]" << std::endl;
	return ;
}
