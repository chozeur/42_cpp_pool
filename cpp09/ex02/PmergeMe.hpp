...
class	PmergeMe {
	...
	public:
		...
		std::vector<int>	mergeInsertionSortVector(void);
		std::list<int>		mergeSortedList(std::list<int> a, std::list<int> b);
		std::list<int>		insertionSortList(std::list<int> arr);
		std::list<int>		mergeInsertionSortList(std::list<int>& arr);
